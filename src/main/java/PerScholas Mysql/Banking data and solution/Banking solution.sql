...
-- 1: Problem Statement:
-- For each product, show the product name "Product" 
-- and the product type name "Type”.
...
-- plus the last name and title of each employee who 
-- works in that branch.
...
-- 5: Problem Statement:
-- For each account, show the name of the account's 
-- product, the available balance, and the customer's last name.
...
-- 6:  Problem Statement:
-- List all account transaction details for individual 
-- customers whose last name starts with 'T'.
